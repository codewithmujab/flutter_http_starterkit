...
// ProfileScreen
class UraianKerjaScreen extends StatefulWidget {
  final String title;

  const UraianKerjaScreen({
    super.key,
    required this.title,
  });

  @override
  State<UraianKerjaScreen> createState() => _UraianKerjaScreenState();
}

class _UraianKerjaScreenState extends State<UraianKerjaScreen> {
